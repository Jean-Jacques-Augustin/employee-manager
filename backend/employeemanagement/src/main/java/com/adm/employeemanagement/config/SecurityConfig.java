package com.adm.employeemanagement.config;

import com.adm.employeemanagement.security.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000")); // Remplacez par votre URL frontend
